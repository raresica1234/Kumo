...
export const APIS = [AuthenticationControllerService, ExplorationRoleControllerService, ExplorationUserRoleControllerService, ExplorerControllerService, PathPointControllerService, PermissionControllerService, UserControllerService];
